          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>WHAT WE OFFER <br /> <span style={{'font-size': '20px'}}>WHY CHOOSE CARGO EXPRESS</span></h2>
                <p>Here at CFB, we give you more control over your shipment and options. All of our clients get free access to our online TMS and have the ability to book shipments, track, retrieve POD’s, and print out your own invoices. You have the control to choose over 29+ carriers and the ability to auto dispatch your orders. Easy, simple, and effective.</p>
